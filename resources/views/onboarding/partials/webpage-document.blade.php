                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div class="mb-3 w-100">
                                ...
                                <select class="form-select form-select-sm credentialType"
                                    ...
                                    <option value="1" {{ $webpage->credential_type === '1' ? 'selected' : '' }}>Domain
                                        Registrar</option>
                                    ...
                                    <option value="5" {{ $webpage->credential_type === '5' ? 'selected' : '' }}>Google
                                        Admin</option>
                                    <option value="6" {{ $webpage->credential_type === '6' ? 'selected' : '' }}>AWS
                                        Admin</option>
                                    <option value="7" {{ $webpage->credential_type === '7' ? 'selected' : '' }}>
                                        Security Cameras</option>
                                    <option value="8" {{ $webpage->credential_type === '8' ? 'selected' : '' }}>Access
                                        Control</option>
                                    <option value="9" {{ $webpage->credential_type === '9' ? 'selected' : '' }}>Cloud
                                    </option>
                                    ...
                                    <option value="14" {{ $webpage->credential_type === '14' ? 'selected' : '' }}>
                                        Web/FTP</option>
                                    <option value="15" {{ $webpage->credential_type === '15' ? 'selected' : '' }}>SQL
                                    </option>
                                    <option value="16" {{ $webpage->credential_type === '16' ? 'selected' : '' }}>WiFi
                                    </option>
                                    <option value="17" {{ $webpage->credential_type === '17' ? 'selected' : '' }}>Other
                                    </option>
                                </select>
                            </div>
                            <div class="mb-3 w-100">
